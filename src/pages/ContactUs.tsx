          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@nimbusware.com</p>
                      <p className="text-gray-600">sales@nimbusware.com</p>
                    </div>
                  </div>
              ...
              <div className="bg-blue-600 rounded-lg shadow-lg p-8 text-white">
                ...
                <p className="mb-4">
                  For urgent technical support or critical issues, our emergency response team is available 24/7.
                </p>
                <div className="space-y-2">
                  <p className="font-semibold">Emergency Hotline:</p>
                  <p className="text-lg">+1 (555) 911-TECH</p>
                </div>
              </div>
            </div>
          </div>
